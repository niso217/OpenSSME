...
import static com.open.ssme.Utils.Constants.FACEBOOK_USER_LOCATION;
import static com.open.ssme.Utils.Constants.PERMISSION;
import static com.open.ssme.Utils.Constants.REQ_START_SHARE;
...

{
    ...
    public void FacebookGetUserLocation(Activity activity){
        LoginManager.getInstance().logInWithReadPermissions(
                activity,
                Arrays.asList(FACEBOOK_USER_LOCATION));
    }
    ...
    public void GooglePostPhoto(Activity activity, Intent intent){
        try {
            ...
            share.setText(activity.getResources().getString(R.string.app_name));
