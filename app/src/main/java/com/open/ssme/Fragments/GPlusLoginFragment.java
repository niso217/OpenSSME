...
import static com.open.ssme.Utils.Constants.GOOGLE_ERROR;
import static com.open.ssme.Utils.Constants.GOOGLE_RC_SIGN_IN;
import static com.open.ssme.Utils.Constants.GOOGLE_REQUEST_CODE;
import static com.open.ssme.Utils.Constants.GOOGLE_RESOLUTION;

public class GPlusLoginFragment extends Fragment implements
        Observer,
        View.OnClickListener {

    private final String TAG = GPlusLoginFragment.class.getSimpleName();
    ...
    private void startResolutionForResult(Intent intent){
        ...
        int statusCode = intent.getIntExtra(GOOGLE_ERROR, 0);
        PendingIntent pendingIntent = intent.getParcelableExtra(GOOGLE_RESOLUTION);
        ConnectionResult connectionResult = new ConnectionResult(statusCode, pendingIntent);
        try {
            connectionResult.startResolutionForResult(getActivity(),GOOGLE_REQUEST_CODE);
